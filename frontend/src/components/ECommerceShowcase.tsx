...
const SECTIONS: ShowcaseSection[] = [
  {
    ...
    description: "A premium e-commerce storefront featuring dynamic hero banners, curated product collections, flash deals, and intelligent product discovery with real-time search and personalized recommendations.",
    image: "/projects/ecommerce/ecommerce-hero.png",
    metrics: [
      { label: "Active Products", value: "12,847" },
      { label: "Monthly Orders", value: "3,847" },
      { label: "Avg Order Value", value: "$458" },
  ...
  },
  {
    ...
    description: "Rich product detail pages with high-resolution image galleries, detailed specifications, customer reviews, ratings, and intelligent cross-selling recommendations for enhanced shopping.",
    image: "/projects/ecommerce/ecommerce-product.png",
    features: [
      "High-resolution image gallery with zoom capability",
      "Detailed product specifications and attributes",
      "Customer reviews with star ratings and verified purchases",
  ...
  },
  {
    id: "cart",
    label: "Shopping Cart",
    title: "Streamlined Cart Experience",
    description: "Modern shopping cart with real-time quantity management, coupon code application, dynamic shipping calculations, and transparent pricing breakdown for frictionless checkout.",
    image: "/projects/ecommerce/ecommerce-cart.png",
    type: "image",
  },
  {
    id: "checkout",
    label: "Secure Checkout",
    title: "Stripe-Inspired Payment Flow",
    description: "Enterprise-grade checkout with Stripe-inspired payment UI, secure card processing, address validation, multiple payment methods, and real-time order confirmation.",
    image: "/projects/ecommerce/ecommerce-checkout.png",
    metrics: [
      { label: "Payment Methods", value: "6" },
      { label: "Avg Checkout Time", value: "1.8m" },
      { label: "Success Rate", value: "97.4%" },
      { label: "Supported Currencies", value: "24" },
    ],
    type: "image",
  },
  {
    ...
    description: "Comprehensive admin panel for product management, order processing, customer analytics, revenue tracking, inventory alerts, and sales performance monitoring.",
    image: "/projects/ecommerce/ecommerce-admin.png",
    type: "image",
  },
  {
    id: "mobile",
    ...
    description: "Fully responsive mobile shopping with touch-optimized browsing, streamlined checkout, push notifications, and seamless synchronization across all devices.",
    type: "mobile-grid",
  },
  {
    id: "tech-stack",
    ...
    title: "Built With",
    description: "Modern e-commerce technology stack engineered for performance, security, and seamless shopping experiences.",
    type: "tech",
  },
  {
    id: "features",
    ...
    description: "Core features that power the E-Commerce Web Application.",
    type: "features",
  },
];

const FEATURES_LIST = [
  { icon: "chart", text: "Product management with inventory tracking and stock alerts" },
  { icon: "users", text: "Customer accounts with order history and wishlist management" },
  { icon: "server", text: "RESTful API with Django REST Framework and rate limiting" },
  { icon: "database", text: "PostgreSQL with optimized product search and categorization" },
  { icon: "shield", text: "JWT authentication with secure payment tokenization" },
  { icon: "clock", text: "Real-time order tracking with status notifications" },
  { icon: "cube", text: "Shopping cart with coupon codes and dynamic shipping" },
  { icon: "terminal", text: "Admin dashboard with sales analytics and reporting" },
];
...
const TECH_GROUPS = [
  ...
  { category: "Payments", items: ["Stripe API", "PayPal SDK", "Square", "Braintree"] },
  { category: "Database", items: ["PostgreSQL", "Redis Cache", "Elasticsearch", "Alembic"] },
  { category: "Auth & Security", items: ["JWT", "OAuth 2.0", "bcrypt", "SSL/TLS"] },
  { category: "DevOps", items: ["Docker", "Railway", "GitHub Actions", "Cloudflare"] },
];
...
function MobileGridSection() {
  const mobileScreens = [
    { src: "/projects/ecommerce/ecommerce-mobile.png", label: "Mobile Store" },
    { src: "/projects/ecommerce/ecommerce-product.png", label: "Product" },
    { src: "/projects/ecommerce/ecommerce-cart.png", label: "Cart" },
    { src: "/projects/ecommerce/ecommerce-checkout.png", label: "Checkout" },
  ];
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-2 text-xl font-bold text-white sm:text-2xl">Mobile-First Shopping</h3>
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-text-muted">
        Fully responsive mobile shopping with touch-optimized browsing, streamlined checkout, push notifications, and seamless device sync.
      </p>
...
function TechStackSection() {
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-text-muted">
        Modern e-commerce technology stack engineered for performance, security, and seamless shopping experiences.
      </p>
...
function FeaturesSection() {
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-text-muted">
        Core features engineered for the E-Commerce Web Application.
      </p>
